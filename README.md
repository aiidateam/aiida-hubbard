...
|-|-|-|-|
| `>= v0.6.0` | ![Compatibility for v4.0][AiiDA v4.0-pydantic3] |  [![PyPI version][Python v3.10-v3.14]](https://pypi.python.org/pypi/aiida-hubbard/0.6.0)  | ![Quantum ESPRESSO compatibility][QE v7.2-7.5] |
| `v0.3.0 <= v0.5.0` | ![Compatibility for v4.0][AiiDA v4.0-pydantic3] |  [![PyPI version][Python v3.9-v3.12]](https://pypi.python.org/pypi/aiida-hubbard/0.5.0) | ![Quantum ESPRESSO compatibility][QE v7.2-7.4] |
| `v0.1.0 <= v0.2.0` | ![Compatibility for v4.0][AiiDA v4.0-pydantic2] |  [![PyPI version][Python v3.9-v3.12]](https://pypi.python.org/pypi/aiida-hubbard/0.2.0) | ![Quantum ESPRESSO compatibility][QE v7.2-7.4] |
