...
|-|-|-|-|
| `v0.3.0 <= v0.5.0` | ![Compatibility for v4.0][AiiDA v4.0-pydantic3] |  [![PyPI pyversions](https://img.shields.io/pypi/pyversions/aiida-hubbard.svg)](https://pypi.python.org/pypi/aiida-hubbard) | ![Quantum ESPRESSO compatibility][QE v7.2-7.5] |
