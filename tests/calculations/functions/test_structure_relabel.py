...
def test_structure_relabel(generate_structure):
    ...
    sites = [
        {'index': 0, 'type': 1, 'kind': 'Co0', 'new_type': 1, 'spin': 1},
        {'index': 1, 'type': 1, 'kind': 'Co0', 'new_type': 2, 'spin': 1},
        {'index': 2, 'type': 3, 'kind': 'Co1', 'new_type': 3, 'spin': -1},
        {'index': 3, 'type': 3, 'kind': 'Co1', 'new_type': 4, 'spin': -1},
        {'index': 4, 'type': 5, 'kind': 'O', 'new_type': 5, 'spin': 1},
        {'index': 5, 'type': 5, 'kind': 'O', 'new_type': 5, 'spin': 1},
    ]
